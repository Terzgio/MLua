...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaScriptingLuaRoomWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 23, 9, 4);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetUpRoom", _m_SetUpRoom);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetUpRoom2", _m_SetUpRoom2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetUpRoom2(RealStatePtr L)
        {
		    try {
