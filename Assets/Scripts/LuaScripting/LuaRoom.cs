...
namespace LuaScripting
{
    ...
    public class LuaRoom : MonoBehaviour
    {
        ...
        /// <summary>
        /// Creates the room's settings domain and runs the custom.lua script.
        /// </summary>
        private void LoadRoomlua()
        {
            //
            //
            //FORTONO TO CUSTOM.LUA
            //
            //
            RoomSettings = LuaDomain.NewLuaDomain("RoomLua", Path.Combine(RoomScriptPath, "custom.lua"), this, false);
            RoomSettings.LuaEnvironment.Set("Room", this);
            RoomSettings.DoScript();
